...
3. Метод writeObject(java.io.ObjectOutputStream s) класса Solution должен
быть synchronized.
4. Метод readObject(java.io.ObjectInputStream s) класса Solution
не должен быть synchronized.
