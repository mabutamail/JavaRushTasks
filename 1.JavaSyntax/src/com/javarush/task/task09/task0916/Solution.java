...
5. Метод handleExceptions должен отлавливать и выводить на экран
все возникающие checked исключения.
...
public class Solution {
    ...
    public static void handleExceptions(Solution obj) {
        try {
            ...
            //e.printStackTrace();
            System.out.println("ffffffffffffff" + e);
...
//            System.out.println(e);
    ...
    public void method3() throws RemoteException {      //unchecked исключение??
